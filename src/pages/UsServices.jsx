  ...
  return (
    <div className="d-center">
      ...
      <Card className="mt-3" style={{ width: "70rem" }}>
        <Card.Body>
          <Card.Title className="color text-align ">Conoce Nuestros Servicios</Card.Title>
        ...
        <ul >
          <li>
            <b>Magda Arnal: </b> nuestra trabajadora social que dará orientación a las
            familias y cuidadores respecto a las ayudas y recursos disponibles.
          </li>

          <li>
            <b>Sandra Daudí:</b> nuestra psicóloga que acompañará emocionalmente a las
          ...
          <li>
            <b>Paula Montón Ferrer:</b> de @alosbrazosdemamá: enseñará a las familias a
          ...
          <li>
            <b>Irene Socorro Gómez:</b> de @tulado.azul encargada de la dirección del
          ...
          <li>
            <b>Noelira Freire:</b> colabora junto con Irene en la creación del Banco de
            Respiro Familiar.
          </li>
        </ul>
